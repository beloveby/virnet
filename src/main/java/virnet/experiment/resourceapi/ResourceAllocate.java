...
public class ResourceAllocate {
	...
	private static final String resourceServerIP = "202.112.113.135";
	private static final int resourceServerPort = 8341;
	private String name_Str;	//�豸����##������������˳��Ϊ�豸��ʵ�����е����
	private String duration;	//��ʵ�������ʱ��
	private String model_NUM = "###";
	private int timeout = 10000;
	
	private Socket connectToServer = null;
	DataOutputStream osToServer = null;	//������������������
	DataInputStream isFromServer = null;	//�ӷ����������������
    ...
    private String cabinetNum = null;	//ʵ������
    private String numStr = null;	//�豸��Ŵ�
    private String portInfoStr = null;	//�豸��Ŵ���Ӧ�µĸ��豸���ö˿������Ϣ��
	
	public ResourceAllocate(String name_str, String duration) {
