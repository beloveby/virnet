...
public class NTCEdit {
	...
	//private String status_Str;		//�༭״̬����0Ϊ�Ͽ���1Ϊ����
	private String leftNUM_Str;		//����豸��Ŵ�����##������
	private String rightNUM_Str;	//�Ҷ��豸��Ŵ�����##������
	private String leftport_Str;	//����豸�˿���Ŵ�����##������
	private String rightport_Str;	//�Ҷ��豸�˿���Ŵ�����##������
	...
	public NTCEdit(String cabinet_num, String leftNUM_str, 
			String rightNUM_str, String leftport_str, String rightport_str) {
